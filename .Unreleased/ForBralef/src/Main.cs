...
namespace ForBralef
{
    static class Main
    {
        ...
        static bool Load(UnityModManager.ModEntry modEntry)
        {
            ...
            if (settings.RememberList) { HeroList = settings.HeroListSave; BuildTheDictionary(); }
        ...
        static void OnGUI(UnityModManager.ModEntry modEntry)
        {
            ...
            settings.RememberList = GUILayout.Toggle(settings.RememberList, "Remember dictionary ?");
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
        }
        ...
        static void OnUpdate(UnityModManager.ModEntry modEntry, float dt)
        {
            ...
            if (!settings.RememberList) settings.HeroListSave = new List<HeroType>();
            if (settings.RememberList) settings.HeroListSave = HeroList;
        ...
        { 
            HeroList.Shuffle();
            Main.Log("List shuffle ! Build dictionary know !!");
